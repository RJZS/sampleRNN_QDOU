...
filename = "sample_e31_i200000_t66.64_tr6.6497_v6.6667"
...
noise_spec = load_binary_file("{}/Spec/{}_4.mcep".format(noise_dir, filename), specdim)
orig_spec = load_binary_file("{}/Spec/{}_4.mcep".format(orig_dir, filename), specdim)
